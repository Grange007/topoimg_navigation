...
ROOT_DIR = os.path.abspath("/home/yzc/project/navigation/LoFTR")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight', type=str, default="/home/yzc/project/navigation/LoFTR/weights/outdoor_ds.ckpt", help="Path to the checkpoint.")
    parser.add_argument(
        '--input', type=str, default='6',
    ...
    while True:
        ...
        print(f'last_frame shape: {last_frame.shape}, frame shape: {frame.shape}')
