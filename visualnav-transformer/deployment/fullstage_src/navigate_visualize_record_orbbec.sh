...
tmux send-keys "conda activate vint_deployment" Enter
tmux send-keys "python3 navigate_visualize_orbbec.py $1 $2 $3 $4" Enter
...
tmux send-keys "rosbag record /waypoint_img -tmux send-keys "python3 teleop_speed_limit.py" Entero $2_$4" Enter # change topic if necessary
