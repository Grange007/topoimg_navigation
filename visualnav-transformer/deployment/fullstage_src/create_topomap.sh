...
tmux send-keys "python3 create_topomap.py --dt 0.06 --dir $1 --topic /topic1" Enter
...
tmux send-keys "rosbag play -r 9 $1 /usb_cam/image_raw:=/topic1" # feel free to change the playback rate to change the edge length in the graph
